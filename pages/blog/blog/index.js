  ...
  if (blog === "first-post") {
    return (
      <div className="post-container">
        <div>
          <img src={Posts[0].cover} alt="postimage" />
          <h1> {Posts[0].title}</h1>
          <p>{Posts[0].body}</p>
          <p>{Posts[0].body}</p>
          <p>{Posts[0].body}</p>
    ...
    return (
      <div className="post-container">
        <div>
          <img src={Posts[1].cover} alt="postimage" />
          <h1> {Posts[1].title}</h1>
          <p>{Posts[1].body}</p>
          <p>{Posts[1].body}</p>
          <p>{Posts[1].body}</p>
    ...
    return (
      <div className="post-container">
        <div>
          <img src={Posts[2].cover} alt="postimage" />
          ...
          <div className="comments">
            ...
            <p>Absolutely spot on! Thanks for sharing, Kingsley!</p>
            <Link legacyBehavior href={fullPath}>
              <a href={fullPath}>Read all comments for this article</a>
            </Link>
          </div>
        </div>
      </div>
